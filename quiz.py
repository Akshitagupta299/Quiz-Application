...
def register():
    ...
    if username in user_data:
        ...
        return
    password = getpass.getpass("Enter your password (REMEMBER : while typing user can't see it, it is hidden for the security purpose ) : ")
...
def take_quiz(username):
    ...
    print(f"Percentage: {(score / len(questions[subject])) * 100:.2f}%")
